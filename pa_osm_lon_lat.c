...
#include<math.h>
int no_of_entry=0;
double curr_long=10.13625,curr_lat = 54.32168,shortest_dist=20020;
...
int main(int argc, char** argv)
{
	...
	printf("Your nearest %s search result is approximately : %1.7f meter far\n",argv[2],shortest_dist);
	stop:
